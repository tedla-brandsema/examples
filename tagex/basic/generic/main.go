...
func (d *EmailDirective[T]) Handle(val T) (T, error) {
	_, err := mail.ParseAddress(string(val))
	return val, err
}
...
func main() {
	...
	tagex.RegisterDirective[string](&checkTag, &EmailDirective[string]{})
